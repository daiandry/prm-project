...
final class Version20201106103404 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prm_user ADD photo_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prm_user ADD CONSTRAINT FK_107BC2307E9E4C8C FOREIGN KEY (photo_id) REFERENCES prm_photos (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_107BC2307E9E4C8C ON prm_user (photo_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prm_user DROP CONSTRAINT FK_107BC2307E9E4C8C');
        $this->addSql('DROP INDEX UNIQ_107BC2307E9E4C8C');
        $this->addSql('ALTER TABLE prm_user DROP photo_id');
    }
}
