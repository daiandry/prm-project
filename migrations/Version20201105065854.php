 ...
 */
final class Version20201105065854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prm_user ADD administration_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prm_user ADD CONSTRAINT FK_107BC23039B8E743 FOREIGN KEY (administration_id) REFERENCES prm_administration (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_107BC23039B8E743 ON prm_user (administration_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prm_user DROP CONSTRAINT FK_107BC23039B8E743');
        $this->addSql('DROP INDEX IDX_107BC23039B8E743');
        $this->addSql('ALTER TABLE prm_user DROP administration_id');
    }
}
