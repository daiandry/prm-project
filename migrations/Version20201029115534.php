 ...
 */
final class Version20201029115534 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prm_user ADD first_login BOOLEAN NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prm_user DROP first_login');
    }
}
