 ...
 */
final class Version20201105081226 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prm_droit ADD bloc VARCHAR(50) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prm_droit DROP bloc');
    }
}
