 ...
 */
final class Version20201111074800 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prm_user ADD region_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_107BC23098260155 ON prm_user (region_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_107BC23098260155');
        $this->addSql('ALTER TABLE prm_user DROP region_id');
    }
}
