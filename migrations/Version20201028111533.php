 ...
 */
final class Version20201028111533 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE prm_administration_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE prm_administration (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, left_bound INT DEFAULT NULL, right_bound INT DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE prm_administration_id_seq CASCADE');
        ...
        $this->addSql('DROP TABLE prm_administration');
    }
}
