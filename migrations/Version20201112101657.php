 ...
 */
final class Version20201112101657 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE prm_statut_projet_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE prm_statut_projet (id INT NOT NULL, libelle VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('DROP TABLE topology.topology');
        $this->addSql('DROP TABLE topology.layer');
        $this->addSql('ALTER TABLE prm_documents ADD mimetype VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE prm_projet ADD statut_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prm_projet ADD CONSTRAINT FK_B4321783F6203804 FOREIGN KEY (statut_id) REFERENCES prm_statut_projet (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_B4321783F6203804 ON prm_projet (statut_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prm_projet DROP CONSTRAINT FK_B4321783F6203804');
        $this->addSql('DROP SEQUENCE prm_statut_projet_id_seq CASCADE');
        ...
        $this->addSql('DROP TABLE prm_statut_projet');
        $this->addSql('DROP INDEX IDX_B4321783F6203804');
        $this->addSql('ALTER TABLE prm_projet DROP statut_id');
        $this->addSql('ALTER TABLE prm_documents DROP mimetype');
    }
}
