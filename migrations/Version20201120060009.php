 ...
 */
final class Version20201120060009 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE ressource_type_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE action_type (id INT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE ressource_type (id INT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('DROP TABLE topology.topology');
        $this->addSql('DROP TABLE topology.layer');
        $this->addSql('ALTER TABLE trace_log ADD ressource_type_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE trace_log ADD ressource_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE trace_log ADD CONSTRAINT FK_B4507C2170760271 FOREIGN KEY (ressource_type_id) REFERENCES ressource_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_B4507C2170760271 ON trace_log (ressource_type_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trace_log DROP CONSTRAINT FK_B4507C2170760271');
        $this->addSql('DROP SEQUENCE action_type_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE ressource_type_id_seq CASCADE');
        ...
        $this->addSql('DROP INDEX IDX_B4507C2170760271');
        $this->addSql('ALTER TABLE trace_log DROP ressource_type_id');
        $this->addSql('ALTER TABLE trace_log DROP ressource_id');
    }
}
