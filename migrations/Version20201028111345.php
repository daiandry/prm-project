 ...
 */
final class Version20201028111345 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE prm_type_admin_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE prm_type_admin (id INT NOT NULL, libelle VARCHAR(50) NOT NULL, code VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE prm_type_admin_id_seq CASCADE');
        ...
        $this->addSql('DROP TABLE prm_type_admin');
    }
}
